...
#	print (i)
	...
	P   = np.loadtxt('transient/data/P'+str(i)+'.dat', skiprows=0, unpack=True)
...
#	plt.contour(x,y,C,colors=('k',),linestyles=('--',),linewidths=(2,), levels=[1/(S+1)])
	plt.contourf(x,y,P,500, cmap=plt.cm.get_cmap('RdBu_r'))
...
#plt.gca().add_patch(circle3)
	plt.savefig('output/presssure'+str(cont)+'.png', bbox_inches='tight')
